...
def parse_version(major=None, minor=None, patch=None, patch_minor=None):
    ...
    return tuple(filter(lambda x: x is not None, (major, minor, patch, patch_minor)))
...
class UserAgent(object):
    ...
    def __str__(self):
        return "{device} / {os} / {browser}".format(
            device=self.get_device(), os=self.get_os(), browser=self.get_browser()
        )
    ...
    def is_mobile(self):
        ...
        if (
            self.os.family == "Android" or self.os.family == "Firefox OS"
