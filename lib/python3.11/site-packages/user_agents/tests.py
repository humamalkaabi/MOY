...
ubuntu_firefox_ua_string = (
    "Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:15.0) Gecko/20100101 Firefox/15.0.1"
)
google_bot_ua_string = (
...
android_firefox_aurora_ua_string = (
...
class UserAgentsTest(unittest.TestCase):
    def test_user_agent_object_assignments(self):
        ...
        self.assertEqual(iphone_ua.browser.family, ua_dict["user_agent"]["family"])
        self.assertEqual(
        ...
        self.assertEqual(iphone_ua.device.family, ua_dict["device"]["family"])
    ...
    def test_strings(self):
        ...
        self.assertEqual(
            str(galaxy_tab), "Samsung SCH-I800 / Android 2.2 / Android 2.2"
        )
        self.assertEqual(
            str(galaxy_s3_ua), "Samsung GT-I9300 / Android 4.0.4 / Android 4.0.4"
        )
        self.assertEqual(str(kindle_fire_ua), "Kindle / Android / Amazon Silk 1.1.0-80")
        self.assertEqual(
            str(playbook_ua),
            "BlackBerry Playbook / BlackBerry Tablet OS 2.0.1 / BlackBerry WebKit 2.0.1",
        )
        self.assertEqual(
            str(nexus_7_ua), "Asus Nexus 7 / Android 4.1.1 / Chrome 18.0.1025"
        )
        self.assertEqual(
            str(windows_phone_ua),
            "Samsung SGH-i917 / Windows Phone 7.5 / IE Mobile 9.0",
        )
        self.assertEqual(str(windows_rt_ua), "PC / Windows RT / IE 10.0")
        self.assertEqual(
            str(blackberry_torch_ua),
            "BlackBerry 9800 / BlackBerry OS 6.0.0 / BlackBerry WebKit 6.0.0",
        )
        self.assertEqual(
            str(blackberry_bold_ua),
            "BlackBerry 9700 / BlackBerry OS 5.0.0 / BlackBerry 9700",
        )
        self.assertEqual(
            str(blackberry_bold_touch_ua),
            "BlackBerry 9930 / BlackBerry OS 7.0.0 / BlackBerry WebKit 7.0.0",
        )
        self.assertEqual(
            str(j2me_opera_ua), "Generic Feature Phone / Other / Opera Mini 9.80"
        )
        self.assertEqual(str(ie_ua), "PC / Windows 8 / IE 10.0")
        self.assertEqual(str(ie_touch_ua), "PC / Windows 8 / IE 10.0")
        self.assertEqual(
            str(mac_safari_ua), "PC / Mac OS X 10.6.8 / WebKit Nightly 537.13"
        )
        ...
        self.assertEqual(
            str(android_firefox_aurora_ua),
            "Generic Smartphone / Android / Firefox Mobile 27.0",
        )
...
def test_wrapper(items):
    def test_func(self):
        attrs = ("is_bot", "is_mobile", "is_pc", "is_tablet", "is_touch_capable")
        for attr in attrs:
